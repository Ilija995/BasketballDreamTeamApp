					...
					<c:forEach items="${PG}" var="pgPlayer">
						<div class="panel panel-default">
							...
							<div class="panel_heading">
								...
								<button type="button" class="btn btn-primary pg_dugme">Add player to your dream team
								</button>
							</div>
					...
					<c:forEach items="${SG}" var="sgPlayer">
						<div class="panel panel-default">
							...
							<div class="panel_heading">
								...
								<button type="button" class="btn btn-primary sg_dugme">Add player to your dream team
								</button>
							</div>
							<!-- dodatne informacije o igracu -->
					...
					<c:forEach items="${SF}" var="sfPlayer">
						<div class="panel panel-default">
							...
							<div class="panel_heading">
								...
								<button type="button" class="btn btn-primary sf_dugme">Add player to your dream team
								</button>
							</div>
							<!-- dodatne informacije o igracu -->
					...
					<c:forEach items="${PF}" var="pfPlayer">
						<div class="panel panel-default">
							...
							<div class="panel_heading">
								...
								<button type="button" class="btn btn-primary pf_dugme">Add player to your dream team
								</button>
							</div>
							<!-- dodatne informacije o igracu -->
					...
					<c:forEach items="${C}" var="centerPlayer">
						<div class="panel panel-default">
							...
							<div class="panel_heading">
								...
								<button type="button" class="btn btn-primary dugme_centri">Add player to your dream
									team
								</button>
							</div>
							<!-- dodatne informacije o igracu -->
